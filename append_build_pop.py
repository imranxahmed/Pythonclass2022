...
def list_ops():
    ...
    menu += 'Pop ENTIRE list: Enter   "pop" \n'
...
def pop_select():
    ...
    while len(my_list) > 0:
        ...
        if pop_item.__eq__(100):
            print('you will be returning to the main program')
            return
...
def insert_list():
    ...
    print('current list is {0}'.format(my_list))
    ...
    try:
         ...
         print('The new list is {0}'.format(my_list))
